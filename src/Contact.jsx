...
export default function Contact() {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 font-mono">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          {/* Image Section */}
          <div className="w-full lg:w-1/2 lg:pr-8">
            <img src="Contact us-rafiki 1.svg" alt="Description" className="rounded-lg shadow-lg w-full h-auto" />
          </div>
          {/* Form Section */}
